...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'b5c56d036cab4d5ea858f9ed217a1f6c',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ai,game,阅读,旅行,思考', // 网站关键词 英文逗号隔开
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/trumps92678', // 你的telegram 地址 
